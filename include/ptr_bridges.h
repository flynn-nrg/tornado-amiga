...
#define ENDI4(V) (V)
#else
#define ENDI4(V) (((V) & 0xff) << 24) | (((V) & 0xff00) << 8) | (((V) & 0xff0000) >> 8) | (((V) & 0xff000000) >> 24)
#endif
...
#define ENDF(RES,PTR) \
{ \
    union { unsigned int r; float f; } brgf; \
    brgf.r = *(unsigned int*) PTR; \
    brgf.r = ((brgf.r & 0xff) << 24) | ((brgf.r & 0xff00) << 8) | ((brgf.r & 0xff0000) >> 8) | ((brgf.r & 0xff000000) >> 24); \
    RES = brgf.f; \
}
#endif
...
{
  union { void* ptr; unsigned long v; } tmp;
  tmp.ptr = ptr;
  return tmp.v;
}
