...
BPLY1	EQU	256
	ENDC
	IFND	BPLSIZ2
BPLSIZ2	EQU	BPLX1*BPLY1/8
	ENDC
	IFND	CHUNKXMAX
CHUNKXMAX EQU	BPLX1
	ENDC
	IFND	CHUNKXMAXY
CHUNKXMAXY EQU	BPLY1
	ENDC
...
; d5.l	(bplsize) [bytes] -- offset between one row in one bpl and the next bpl
	...
	XDEF	_c2p1x1_8_c5_init

_c2p1x1_8_c5_init
	movem.l	d2-d3,-(sp)
	lea	ctp_datanew(pc),a0
	andi.l	#$ffff,d0
	mulu.w	d0,d3
	lsr.l	#3,d3
