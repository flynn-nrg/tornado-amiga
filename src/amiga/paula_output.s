...
PaulaOutput_MixAheadFrames	= 2		; Number of frames which the mixer should mix ahead
...
PaulaOutput_Mode_Stereo_BIT = 1
	...
	section	code,code
	public _PaulaOutput_Init
	public _PaulaOutput_Start
	public _PaulaOutput_ShutDown
	public _PaulaOutput_VertBCallback
	public _Get_PaulaOutput_VertBCallback
...
; in	a0	mix routine
;;; 	a1	mix state
;;;	a2	mix state 2 for non-interleaved audio. 
; 	d0.w	replay period
...
_PaulaOutput_Init
		...
		move.l	a2,PaulaOutput_MixState2
...
_PaulaOutput_ShutDown
		sf	PaulaOutput_MixActive
		bra	PaulaOutput_KillAudioHardware

;;; ---------------------------------------------------------------------------
;;; Helper routine to obtain a pointer to the VBL callback.
;;; ---------------------------------------------------------------------------
_Get_PaulaOutput_VertBCallback
	lea _PaulaOutput_VertBCallback, a0
	move.l a0, d0
	rts
...
.clampAgainstBufferEnd
		...
		move.l  PaulaOutput_MixState2,a6
		jsr	(a5)
