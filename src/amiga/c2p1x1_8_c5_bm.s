;
; Date: 16-Sep-1997			Mikael Kalms (Scout/C-Lous & more)
;
...
.c2p_mod
	...
	add.w	c2p1x1_8_c5_bm_chunkyx(pc),a2
	add.w	#32,a2
	...
	bra	.modx1start
.modx1y
	add.w	c2p1x1_8_c5_bm_chunkyx(pc),a2 ; Skip to end of next line + 1
					      ; iter
	move.l	c2p1x1_8_c5_bm_rowmod(pc),d0 ; Skip to beginning of next line
	add.l	d0,a3
	add.l	d0,a4
	add.l	d0,a5
	add.l	d0,a6
