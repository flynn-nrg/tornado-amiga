...
Download the [Amiga NDK](http://www.haage-partner.de/download/AmigaOS/NDK39.lha) and unpack it. Move the contents to the ```third_party/ndk``` directory. You should end up with a directory structure like this:
...
Download BASS for OSX and GNU/Linux and unpack it in the ```third_party``` directory.
