...
TORNADO_OBJ += tndo.o debug.o wav_delta.o memory.o caps_loader.o de-encapsulator.o telemetry.o prof.o lzw_loader.o lzss_loader.o lzh_loader.o lzw_unpack_stream.o tndo_file.o dprint.o
